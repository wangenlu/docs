...
-	[`13.0.11RC1-apache`, `13.0.11-rc-apache`, `13.0-rc-apache`, `13-rc-apache`, `13.0.11RC1`, `13.0.11-rc`, `13.0-rc`, `13-rc` (*13.0-rc/apache/Dockerfile*)](https://github.com/nextcloud/docker/blob/e298a56eaa4fc928fcdbfbe2fd8df9a907ff7b41/13.0-rc/apache/Dockerfile)
-	[`13.0.11RC1-fpm-alpine`, `13.0.11-rc-fpm-alpine`, `13.0-rc-fpm-alpine`, `13-rc-fpm-alpine` (*13.0-rc/fpm-alpine/Dockerfile*)](https://github.com/nextcloud/docker/blob/e298a56eaa4fc928fcdbfbe2fd8df9a907ff7b41/13.0-rc/fpm-alpine/Dockerfile)
-	[`13.0.11RC1-fpm`, `13.0.11-rc-fpm`, `13.0-rc-fpm`, `13-rc-fpm` (*13.0-rc/fpm/Dockerfile*)](https://github.com/nextcloud/docker/blob/e298a56eaa4fc928fcdbfbe2fd8df9a907ff7b41/13.0-rc/fpm/Dockerfile)
-	[`13.0.10-apache`, `13.0-apache`, `13-apache`, `13.0.10`, `13.0`, `13` (*13.0/apache/Dockerfile*)](https://github.com/nextcloud/docker/blob/e8e33356ff876b9080d3322130c4b73ab2448655/13.0/apache/Dockerfile)
-	[`13.0.10-fpm-alpine`, `13.0-fpm-alpine`, `13-fpm-alpine` (*13.0/fpm-alpine/Dockerfile*)](https://github.com/nextcloud/docker/blob/e8e33356ff876b9080d3322130c4b73ab2448655/13.0/fpm-alpine/Dockerfile)
-	[`13.0.10-fpm`, `13.0-fpm`, `13-fpm` (*13.0/fpm/Dockerfile*)](https://github.com/nextcloud/docker/blob/e8e33356ff876b9080d3322130c4b73ab2448655/13.0/fpm/Dockerfile)
-	[`14.0.7RC1-apache`, `14.0.7-rc-apache`, `14.0-rc-apache`, `14-rc-apache`, `14.0.7RC1`, `14.0.7-rc`, `14.0-rc`, `14-rc` (*14.0-rc/apache/Dockerfile*)](https://github.com/nextcloud/docker/blob/f0f22d3ddfbb1dd2893f7b6cbacb4fc4e4ed24db/14.0-rc/apache/Dockerfile)
-	[`14.0.7RC1-fpm-alpine`, `14.0.7-rc-fpm-alpine`, `14.0-rc-fpm-alpine`, `14-rc-fpm-alpine` (*14.0-rc/fpm-alpine/Dockerfile*)](https://github.com/nextcloud/docker/blob/f0f22d3ddfbb1dd2893f7b6cbacb4fc4e4ed24db/14.0-rc/fpm-alpine/Dockerfile)
-	[`14.0.7RC1-fpm`, `14.0.7-rc-fpm`, `14.0-rc-fpm`, `14-rc-fpm` (*14.0-rc/fpm/Dockerfile*)](https://github.com/nextcloud/docker/blob/f0f22d3ddfbb1dd2893f7b6cbacb4fc4e4ed24db/14.0-rc/fpm/Dockerfile)
-	[`14.0.6-apache`, `14.0-apache`, `14-apache`, `production-apache`, `14.0.6`, `14.0`, `14`, `production` (*14.0/apache/Dockerfile*)](https://github.com/nextcloud/docker/blob/e8e33356ff876b9080d3322130c4b73ab2448655/14.0/apache/Dockerfile)
-	[`14.0.6-fpm-alpine`, `14.0-fpm-alpine`, `14-fpm-alpine`, `production-fpm-alpine` (*14.0/fpm-alpine/Dockerfile*)](https://github.com/nextcloud/docker/blob/e8e33356ff876b9080d3322130c4b73ab2448655/14.0/fpm-alpine/Dockerfile)
-	[`14.0.6-fpm`, `14.0-fpm`, `14-fpm`, `production-fpm` (*14.0/fpm/Dockerfile*)](https://github.com/nextcloud/docker/blob/e8e33356ff876b9080d3322130c4b73ab2448655/14.0/fpm/Dockerfile)
-	[`15.0.3RC1-apache`, `15.0.3-rc-apache`, `15.0-rc-apache`, `15-rc-apache`, `rc-apache`, `15.0.3RC1`, `15.0.3-rc`, `15.0-rc`, `15-rc`, `rc` (*15.0-rc/apache/Dockerfile*)](https://github.com/nextcloud/docker/blob/a8a7cb95712d394b4d7c5f0af23c791d1f89cb47/15.0-rc/apache/Dockerfile)
-	[`15.0.3RC1-fpm-alpine`, `15.0.3-rc-fpm-alpine`, `15.0-rc-fpm-alpine`, `15-rc-fpm-alpine`, `rc-fpm-alpine` (*15.0-rc/fpm-alpine/Dockerfile*)](https://github.com/nextcloud/docker/blob/a8a7cb95712d394b4d7c5f0af23c791d1f89cb47/15.0-rc/fpm-alpine/Dockerfile)
-	[`15.0.3RC1-fpm`, `15.0.3-rc-fpm`, `15.0-rc-fpm`, `15-rc-fpm`, `rc-fpm` (*15.0-rc/fpm/Dockerfile*)](https://github.com/nextcloud/docker/blob/a8a7cb95712d394b4d7c5f0af23c791d1f89cb47/15.0-rc/fpm/Dockerfile)
-	[`15.0.2-apache`, `15.0-apache`, `15-apache`, `apache`, `stable-apache`, `15.0.2`, `15.0`, `15`, `latest`, `stable` (*15.0/apache/Dockerfile*)](https://github.com/nextcloud/docker/blob/d8d9a17be25ea0b3acd34914065cb1f085d36ec6/15.0/apache/Dockerfile)
-	[`15.0.2-fpm-alpine`, `15.0-fpm-alpine`, `15-fpm-alpine`, `fpm-alpine`, `stable-fpm-alpine` (*15.0/fpm-alpine/Dockerfile*)](https://github.com/nextcloud/docker/blob/d8d9a17be25ea0b3acd34914065cb1f085d36ec6/15.0/fpm-alpine/Dockerfile)
-	[`15.0.2-fpm`, `15.0-fpm`, `15-fpm`, `fpm`, `stable-fpm` (*15.0/fpm/Dockerfile*)](https://github.com/nextcloud/docker/blob/d8d9a17be25ea0b3acd34914065cb1f085d36ec6/15.0/fpm/Dockerfile)
